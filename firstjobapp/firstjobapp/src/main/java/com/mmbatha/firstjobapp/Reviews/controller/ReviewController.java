package com.mmbatha.firstjobapp.Reviews.controller;
...
@RestController
@RequestMapping("/companies/{companyId}")//rerout
public class ReviewController {
    ...
    public ResponseEntity<String> deleteReview(@PathVariable Long companyId,
                                               @PathVariable Long reviewId) {
        boolean isDeleted = reviewService.deleteCompanyReview(companyId,reviewId);
